...
result: pass
user_confirmed: "2026-06-19 — device-confirmed the redesigned server-down behavior (cached app + 'Server unavailable' banner + read-only instead of the card; auto-recovers on API return)."
