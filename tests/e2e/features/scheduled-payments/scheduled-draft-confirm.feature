...
Feature: Confirm a pending scheduled draft mints a ledger transaction
  ...
  Background:
    ...
    And I have a monthly scheduled rule "Rent" of 1500 USD anchored to day 1 in category "Rent"
