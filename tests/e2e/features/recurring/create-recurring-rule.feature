...
Feature: Create recurring rule
  ...
  Background:
    Given I am signed in as a fresh user with workspace "Recurring Test Workspace"
  ...
  Scenario: User creates a monthly recurring rule and sees it listed
    ...
    And I fill the recurring rule form with amount "1500.00", currency "USD", cadence "MONTHLY", anchorDay "1", firstDueDate "2026-06-01", note "Rent"
