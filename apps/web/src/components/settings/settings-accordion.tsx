...
export interface SettingsBudget {
  ...
  /** R2: caller's self-set ownership share % (0..100) — feeds AggregationSection's
   *  share field, shown only while includeInAggregation is on. Default 100. */
  sharePct?: number;
