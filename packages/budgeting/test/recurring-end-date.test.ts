/**
 * recurring-end-date.test.ts — the end_date (a.k.a. "last date") cutoff for
 * recurring rules. A rule stops producing drafts once its next occurrence
...
import { isRuleExhausted } from "../src/domain/recurring-end-date";
