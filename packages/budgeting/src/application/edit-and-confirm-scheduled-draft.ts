/**
 * edit-and-confirm-scheduled-draft.ts — Edit draft fields then confirm in one atomic tx.
 *
...
export interface EditAndConfirmScheduledDraftDeps {
...
export function editAndConfirmScheduledDraft(
  deps: EditAndConfirmScheduledDraftDeps = {},
) {
  return async (
    ...
    if (
      ...
      if (recomputeR.isErr()) {
        console.error(
          "[edit-and-confirm-scheduled-draft] reserve-topup recompute failed:",
          recomputeR.error,
        );
      }
    }
