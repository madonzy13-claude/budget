/**
 * scheduled-payments-schema.ts — Drizzle schema for budgeting.scheduled_payments
...
export const scheduledPayments = budgeting.table(
  "scheduled_payments",
  {
  ...
  (t) => [
    ...
    pgPolicy("scheduled_payments_tenant_isolation", {
      as: "permissive",
      for: "all",
